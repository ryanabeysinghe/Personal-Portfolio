  ...
  return (
    <div className='flex fixed left-4 bottom-4 items-center justify-center overflow-hidden md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute sm:right-0'>
        <div className='w-48 h-auto flex items-center justify-center relative md:w-24'>
            ...
            className={`flex items-center justify-center absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-salmon text-dark dark:bg-salmon dark:text-light text-2xl shadow-md border border-solid border-dark dark:border-light w-20 h-20 rounded-full font-semibold tracking-wider md:w-12 md:h-12 md:text-[1rem]`}
