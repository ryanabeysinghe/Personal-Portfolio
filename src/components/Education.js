        ...
        <>
            <div className='mt-64 mb-28 md:my-32'>
                ...
                <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
                    ...
                    <motion.div style={{ scaleY: scrollYProgress }} className='absolute left-9 top-4 w-[4px] h-[95.4%] bg-dark dark:bg-light origin-top md:left-[20px] xs:w-[3px] xs:left-[10.5px] xxxs:left-[6.5px]' />
