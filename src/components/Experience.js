        ...
        <>
            <div className='my-64 md:my-32'>
                ...
                <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
                    ...
                    <motion.div style={{ scaleY: scrollYProgress }} className='absolute left-9 top-3 w-[4px] h-[80%] bg-dark dark:bg-light origin-top md:left-[20px] xs:w-[3px] xs:left-[18.5px] xxs:left-[16.5px] xxxs:left-[12.5px]' />
