                    ...
                    <div className='grid w-full grid-cols-8 gap-16'>
                        ...
                        <div className='col-span-2 flex flex-col items-end justify-between'>
                            ...
                            <div className='flex flex-col items-end justify-center'>
                                ...
                                <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light/75'>years of F/E experience</h2>
                            </div>
                            ...
                            <div className='flex flex-col items-end justify-center'>
                                ...
                                <h2 className='text-xl font-medium capitalize text-dark/75 dark:text-light/75'>years of B/E experience</h2>
                            </div>
