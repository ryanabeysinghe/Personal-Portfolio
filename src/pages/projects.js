...
const FeaturedProject = ({ projectImg, projectType, projectTitle, projectDescription, gitHubURL, projectURL }) => {
    ...
    <article className='w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12'>
      ...
      <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
        ...
        <div className='mt-2 flex items-center'>
          ...
          <Link href={gitHubURL} target={"_blank"} className='w-10 ml-4'> <GithubIcon /> </Link>
        </div>
        ...
        <Layout className='pt-16'>
          ...
          <div className='grid grid-cols-12 gap-24'>
            ...
            <div className='col-span-12'>
              <FeaturedProject projectImg={RandSConstructionsWebsiteProj} projectType='Featured Project' projectTitle='R & S Constructions LLC Website'
