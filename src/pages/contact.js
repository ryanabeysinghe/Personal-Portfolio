    ...
    <>
      ...
      <main className='w-full flex flex-col items-center justify-center mb-16'>
        <Layout className='pt-16'>
          ...
          {/* <Container> */}
          <div className='w-full max-w-[650px] mx-auto flex flex-col h-auto relative items-center justify-between border-2 border-solid rounded-br-3xl rounded-3xl shadow-2xl p-12 border-dark bg-light dark:border-light dark:bg-dark md:max-w-[550px] sm:max-w-[450px] xs:max-w-[350px] xs:p-8 xxs:max-w-[300px] xxxs:p-6 '>
